...
if __name__ == '__main__':
    ...
    colors=["hotpink","brown","olive","green","lime",
            "navy","cyan","deepskyblue","b","orange","red"]
    ...
    plotfile=amrfolder+"result/amrSi-fRMSE-all3.png"
    ...
    #Read force/RMSE data of 1500-mix sample with node=40
    ...
    #Plotting force/RMSE of each sample
