...
if __name__ == '__main__': 
    ...
    for orgfld in orgflds :
        ...
        with open(orgxyzfile, mode='r') as org:
            ...
            for i in range(1,11):
                xyzfile=orgdatafolder+fldname+"/1000Kmix7-700-"+str(i)+".xyz"
                ...
                msg1='1000Kmix7-'+str(i)+': '+str(len(samples))+' samples are '
                msg=msg1+'picked up from '+str(datalen)+' data of '+orgfld
                print(msg)
    ...
    for i in range(1,11):
        ...
        dataorgin=orgdatafolder+fldname+"/"+dataname
        for j in range(1,11):
