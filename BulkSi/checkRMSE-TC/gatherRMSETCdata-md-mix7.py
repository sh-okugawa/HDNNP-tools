...
from RMSE/TC data of MD samples (700samples from 5000samples of 1000K-LCx7)
...
if __name__ == '__main__': 
    ...
    colors=["red","orange","pink","lime","cyan","deepskyblue","b","gray"]
    ...
    with open(rstfile, 'w') as rslt:
        ...
        for grp in grps:
            ...
            for j in range(1, 11):
                ...
                if grp=='mix':
                    datadir= mdfolder+"1000K-LC7/"+grp+"/"+str(j)+"/1"
                else:
                    datadir= mdfolder+"1000K-LC7/"+grp+"/"+str(j)
    ...
    #Plotting force/RMSE and TC error of each sample
    allplotfile=plotdir+"alldata-md-LC7.png"
    fig = plt.figure()
    ax1 = fig.add_subplot(111)
    plt.title("MD 1000K-LC7 & LCmix & gs")
