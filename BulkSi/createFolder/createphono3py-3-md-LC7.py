...
/predict-phono3py-3 folder in order to run phono3py again by 
...
def fileEdit(datadir):
    ...
    os.makedirs(datadir+"/predict-phono3py-3")
    dirorg = datadir+"/predict-phono3py/"
    dirdest = datadir+"/predict-phono3py-3"
...
if __name__ == '__main__': 
    ...
    print(f'Copied phono3py-3 of /1000K-LC7/{grp}')