...
def plotL2TC(LC7root, outfolder, grps, md):
    ...
    for grpnum,grp in enumerate(grps):
        ...
        for i in range(1,10):
            ...
            pdtsetfile=datadir+"/predict-phono3py/output-phono3py/symmetry_function-pred-prepro.npz"
...
if __name__ == '__main__': 
    ...
    outfolder=root+"result-LC7n/Mdist/cov/"
    AIgrps=['0.95','0.97','0.99','1.00','1.01','1.03','1.05','mix']
    plotL2TC(LC7root,outfolder,AIgrps,"AIMD-LC7")