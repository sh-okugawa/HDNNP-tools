...
def gatherRMSETC(LC7folder,rstfolder, smpl):
    #gather force/RMSE & TC data  
    rstfile=rstfolder+smpl+"/RMSETCdata.csv"
    traindir=rstfolder+smpl+"/traincv/"
    ...
    with open(rstfile, 'w') as rslt:
        ...
        for j in range(1, 11):
            dataname="mix-"+str(j)
            datadir= LC7folder+"mix/"+smpl+"/"+str(j)
            ...
            print(f'{LC7folder}{dataname} data is gathered and train curve is plotted')    

if __name__ == '__main__': 
    oldLC7folder="/home/okugawa/HDNNP/Si-190808/1000K-LC7/"
    newLC7folder="/home/okugawa/HDNNP/Si-200917/1000K-LC7/"

    #gather force/RMSE & TC data of 3500smpl by original HDNNP 
    oldrstfolder= "/home/okugawa/HDNNP/Si-190808/result-LC7/"
    gatherRMSETC(oldLC7folder,oldrstfolder, "3500smpl")
    
    #gather force/RMSE & TC data of 3500smpl by new HDNNP with Lin&SMZ SF 
    newrstfolder= newLC7folder+"result/"
    gatherRMSETC(newLC7folder,newrstfolder, "3500smpl-Lin")
    gatherRMSETC(newLC7folder,newrstfolder, "3500smpl-SMZ")
