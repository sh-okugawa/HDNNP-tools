...
/predict-phono3py-4 folder in order to run phono3py again by 
...
def fileEdit(datadir):
    ...
    os.makedirs(datadir+"/predict-phono3py-4")
    dirorg = datadir+"/predict-phono3py/"
    dirdest = datadir+"/predict-phono3py-4"
...
if __name__ == '__main__': 
    ...
    for grp in grps:
        ...
        print(f'Copied phono3py-4 of /1000K-LC7/{grp}')