...
if __name__ == '__main__':
    ...
    grps= ["TL3-L7","TL3-LM3","TM3-L7","TM3-LM3","TH3-L7","TH3-LM3","all60"]
    ...
    colors=["red","orange","green","lime","b","cyan","brown","pink"]
    lbls=["T:L3-L:7(2100)","T:L3-L:3(900)","T:M3-L:7(2100)","T:M3-L:3(900)",
          "T:H3-L:7(2100)","T:H3-L:3(900)","T:5-L:7(2100)","small(2100)"]
