...
if __name__ == '__main__': 
    ...
    sumdiffnd=np.array(sumdiff)
    sumdnn=sumdiffnd.T[0]
    fcvecnd=np.array(fcvec)
    fcvnn=fcvecnd.T[0]
    savefile=forcefolder+"amrsi-315f-save"
    np.savez(savefile,sumdiff=sumdnn,fcvec=fcvnn)
