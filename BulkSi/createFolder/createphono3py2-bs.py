...
if __name__ == '__main__': 
    ...
    for bsx in bsxs:
        for j in range(1, 11):
            shutil.rmtree(root+"/"+bsx+"-d20n50/"+str(j)+"/predict-phono3py2")
            os.makedirs(root+"/"+bsx+"-d20n50/"+str(j)+"/predict-phono3py2")
            dirorg = root+"/"+bsx+"-d20n50/"+str(j)+"/predict-phono3py/"
            dirdest = root+"/"+bsx+"-d20n50/"+str(j)+"/predict-phono3py2"
